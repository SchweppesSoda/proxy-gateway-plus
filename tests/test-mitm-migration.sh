...
: > "$WORK/rules/geosite_apple.txt"; : > "$WORK/rules/custom_direct.txt"; : > "$WORK/rules/custom_hijack.txt"; : > "$WORK/rules/ruleset_direct.txt"; : > "$WORK/rules/ruleset_hijack.txt"; : > "$WORK/rules/unlock.txt"
