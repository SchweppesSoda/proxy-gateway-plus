...
Assert-Contains $install 'install_vps2_sni_quic_backend' 'main menu identifies VPS2 backend services'
Assert-Contains $readme 'sniproxy/quic-proxy' 'README clarifies local VPS1 SNI/QUIC mode'
Assert-Contains $readme '--vps1-forward' 'README clarifies VPS2 forwarding mode'
